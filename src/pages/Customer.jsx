...
const Customer = (props) => {
     ...
     const handleAddPayment = async (e) => {
          ...
          if (
               ...
               const response = await fetch('https://inquisitive-red-sun-hat.cyclic.app/api/credit', {
                    method: 'POST',
     ...
     const handlePaymentDelete = async () => {
          const response = await fetch('https://inquisitive-red-sun-hat.cyclic.app/api/credit/' + paymentid, {
               method: 'DELETE',
               headers: {
                    'Authorization': `Bearer ${user.token}`
               }
     ...
     useEffect(() => {
          const fetchCustomer = async () => {
               if (user) {
                    const response = await fetch('https://inquisitive-red-sun-hat.cyclic.app/api/credit' + customer_id, {
                         headers: {
                              'Authorization': `Bearer ${user.token}`
                         }
                    });
