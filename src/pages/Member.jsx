...
const Member = (props) => {
     ...
     //      const columnWidths = [
     //           { wch: 10.25 }, // date
     //           { wch: 12.13 }, // share_capital_debit
     //           { wch: 10.88 }, // share_capital_credit
     //           { wch: 13  }, // coop_savings_debit
     //           { wch: 11.38 }, // coop_savings_credit
     //           { wch: 11.75 }, // share_capital_balance
     //           { wch: 17.63 }  // reference_document
     //      ];
     //      // const columnWidths = [
     //      //      { wch: 11.67 }, // date
