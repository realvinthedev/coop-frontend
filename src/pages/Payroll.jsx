...
const Payroll = (props) => {
     ...
     useEffect(() => {
          const fetchEmp = async () => {
               const response = await fetch(`https://c-back-1-21-25.onrender.com/api/payslip/`, {
                    headers: {
                         'Authorization': `Bearer ${user.token}`
                    }
               })
     ...
     useEffect(() => {
          const fetchEmp = async () => {
               const response = await fetch('https://c-back-1-21-25.onrender.com/api/additional/' + employeeId, {
                    headers: {
                         'Authorization': `Bearer ${user.token}`
                    }
               })
     ...
     useEffect(() => {
          const fetchEmp = async () => {
               const response = await fetch('https://c-back-1-21-25.onrender.com/api/employee/' + employeeId, {
                    headers: {
                         'Authorization': `Bearer ${user.token}`
                    }
               })
               ...
               if (!isDuplicate) {
                    ...
                    if (isAlreadyApproved) {
                         ...
                         if (
                              ...
                              const response = await fetch(`https://c-back-1-21-25.onrender.com/api/payslip/${employeeId}`, {
                                   method: 'PATCH',
                                   body: JSON.stringify(payslip),
                                   headers: {
                                        'Content-Type': 'application/json',
     ...
     const handleApproval = async (transaction) => {
          ...
          if (transaction.approval_status === 'PENDING' || transaction.approval_status === 'REJECTED') {
               ...
               const response = await fetch(`https://c-back-1-21-25.onrender.com/api/payslip/${transaction.employee_id}`, {
                    method: 'PATCH',
