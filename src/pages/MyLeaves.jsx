...
const MyLeaves = (props) => {
     ...
     const handleAdd = async (e) => {
          ...
          const response = await fetch('https://c-back-1-21-25.onrender.com/api/leaves', {
               method: 'POST',
     ...
     const handlePatch = async () => {
          ...
          const response = await fetch('https://c-back-1-21-25.onrender.com/api/employee/leave/' + currentUser, {
               method: 'PATCH',
